...
?                                   ^
+ #define CONFIG_BT_BUF_ACL_TX_SIZE 87
?                                   ^
- #define CONFIG_BT_BUF_ACL_RX_SIZE 69
?                                   ^^
+ #define CONFIG_BT_BUF_ACL_RX_SIZE 87
?                                   ^^
- #define CONFIG_BT_L2CAP_TX_MTU 65
?                                ^^
+ #define CONFIG_BT_L2CAP_TX_MTU 83
?                                ^^
...
?                                        ^^
+ #define CONFIG_BT_CTLR_DATA_LENGTH_MAX 87
?                                        ^^
...
+ #define CONFIG_BT_GATT_CHRC_POOL_SIZE 5
...
+ #define CONFIG_BT_ADV_PROV_FAST_PAIR 1
+ #define CONFIG_BT_ADV_PROV_FAST_PAIR_ADV_BUF_SIZE 26
+ #define CONFIG_BT_ADV_PROV_FAST_PAIR_SHOW_UI_PAIRING 1
+ #define CONFIG_BT_ADV_PROV_FAST_PAIR_BATTERY_DATA_NONE 1
+ #define CONFIG_BT_ADV_PROV_FAST_PAIR_AUTO_SET_PAIRING_MODE 1
+ #define CONFIG_BT_ADV_PROV_FAST_PAIR_STOP_DISCOVERABLE_ON_RPA_ROTATION 1
+ #define CONFIG_BT_ADV_PROV_FLAGS 1
+ #define CONFIG_BT_ADV_PROV_GAP_APPEARANCE 1
+ #define CONFIG_BT_ADV_PROV_GAP_APPEARANCE_SD 1
...
+ #define CONFIG_BT_ADV_PROV_TX_POWER_CORRECTION_VAL -15
...
+ #define CONFIG_BT_FAST_PAIR 1
+ #define CONFIG_BT_FAST_PAIR_USE_CASE_INPUT_DEVICE 1
+ #define CONFIG_BT_FAST_PAIR_SUBSEQUENT_PAIRING 1
+ #define CONFIG_BT_FAST_PAIR_REQ_PAIRING 1
+ #define CONFIG_BT_FAST_PAIR_PN 1
+ #define CONFIG_BT_FAST_PAIR_BN 1
+ #define CONFIG_BT_FAST_PAIR_CRYPTO 1
+ #define CONFIG_BT_FAST_PAIR_CRYPTO_OBERON 1
+ #define CONFIG_BT_FAST_PAIR_CRYPTO_AES256_ECB_SUPPORT 1
+ #define CONFIG_BT_FAST_PAIR_CRYPTO_SECP160R1_SUPPORT 1
+ #define CONFIG_BT_FAST_PAIR_CRYPTO_SECP256R1_SUPPORT 1
+ #define CONFIG_FP_CRYPTO_LOG_LEVEL_DEFAULT 1
+ #define CONFIG_FP_CRYPTO_LOG_LEVEL 3
+ #define CONFIG_BT_FAST_PAIR_STORAGE 1
+ #define CONFIG_BT_FAST_PAIR_STORAGE_MANAGER 1
+ #define CONFIG_BT_FAST_PAIR_STORAGE_AK_BOND 1
+ #define CONFIG_BT_FAST_PAIR_STORAGE_AK 1
+ #define CONFIG_BT_FAST_PAIR_STORAGE_AK_BACKEND_STANDARD 1
+ #define CONFIG_BT_FAST_PAIR_STORAGE_ACCOUNT_KEY_MAX 5
+ #define CONFIG_BT_FAST_PAIR_STORAGE_PN 1
+ #define CONFIG_BT_FAST_PAIR_STORAGE_PN_LEN_MAX 64
+ #define CONFIG_FP_STORAGE_LOG_LEVEL_DEFAULT 1
+ #define CONFIG_FP_STORAGE_LOG_LEVEL 3
  #define CONFIG_SYSTEM_WORKQUEUE_PRIORITY -1
+ #define CONFIG_BT_FAST_PAIR_ACTIVATION 1
+ #define CONFIG_BT_FAST_PAIR_KEYS 1
+ #define CONFIG_BT_FAST_PAIR_AUTH 1
+ #define CONFIG_BT_FAST_PAIR_ADVERTISING 1
+ #define CONFIG_BT_FAST_PAIR_GATT_SERVICE 1
+ #define CONFIG_BT_FAST_PAIR_GATT_SERVICE_MODEL_ID 1
+ #define CONFIG_BT_FAST_PAIR_GATT_SERVICE_ADDITIONAL_DATA 1
  #define CONFIG_BT_GATT_AUTO_SEC_REQ 1
+ #define CONFIG_BT_FAST_PAIR_REGISTRATION_DATA 1
+ #define CONFIG_BT_FAST_PAIR_REGISTRATION_DATA_INIT_PRIORITY 0
+ #define CONFIG_BT_FAST_PAIR_BATTERY 1
+ #define CONFIG_BT_FAST_PAIR_STORAGE_INTEGRATION 1
+ #define CONFIG_BT_FAST_PAIR_STORAGE_INTEGRATION_INIT_PRIORITY 4
+ #define CONFIG_BT_FAST_PAIR_BOND_MANAGER 1
+ #define CONFIG_BT_FAST_PAIR_LOG_LEVEL_DBG 1
+ #define CONFIG_BT_FAST_PAIR_LOG_LEVEL 4
...
+ #define CONFIG_BT_DIS_PNP_PID 0xEEED
+ #define CONFIG_BT_DIS_PNP_VER 0x1
+ #define CONFIG_BT_DIS_FW_REV 1
+ #define CONFIG_BT_DIS_FW_REV_STR "0.0.0+0"
...
?                                ^
+ #define CONFIG_BT_RPA_TIMEOUT 960
?                                ^
...
?                                     ++
  ...
  #define CONFIG_TFM_BOARD "C:/ncs/vturkana/zephyr/modules/trusted-firmware-m/nordic/nrf54l15_cpuapp"
